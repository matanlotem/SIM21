    ...
    JLW21 = zeros(N,N,N);
        ...
        if(feedback)
            ...
            for jj=1:2    
                ...
                load(strcat('/scratch/matanlotem/Data/JLW_',num2str(zint(jj)),'_',num2str(ncube),'_',num2str(fstar),'_',num2str(flag),...
...
PrevNeut=ones(128,128,128);
   ...
   load(strcat('/scratch300/matanlotem/Data/xHI_',num2str(zs(q+1)),'_',num2str(ncube),'_',num2str(fstar),'_',num2str(flag),...
...
save(strcat('/scratch300/matanlotem/Data/xHI_',num2str(zcenter),'_',num2str(ncube),'_',num2str(fstar),'_',num2str(flag),...
                        '_',num2str(flagM),'_',num2str(XeffTerm),'_',num2str(Ispec),'_',num2str(Reion),'_',num2str(feedback),...
                        '_',num2str(p),'_',num2str(pop),'_',num2str(FSfunc),'_',num2str(photoheatingVersion),'.mat'),'xHI');

save(strcat('/scratch300/matanlotem/Data/Neut_',num2str(zcenter),'_',num2str(ncube),'_',num2str(fstar),'_',num2str(flag),...
                    '_',num2str(flagM),'_',num2str(XeffTerm),'_',num2str(Ispec),'_',num2str(Reion),'_',num2str(feedback),'_',...
