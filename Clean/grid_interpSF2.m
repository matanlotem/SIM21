...
if(z>65)%||z==15)
    ...
    if Ispec>2
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridMMQ_',num2str(z),'.mat')); %Q
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridAMQ_',num2str(z),'.mat'));   %Q
    ...
    if Ispec>2
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridMMQ10_',num2str(z),'.mat')); %Q
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridAMQ10_',num2str(z),'.mat'));   %Q
    %gridMMQ=zeros(size(gridAMQ)); %MQ doesn't form below atomic cooling mass according to Tal Alexander's work
    end
     end
      if FSfunc==2
    ...
    if Ispec>2
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridM10SharpMQ_',num2str(z),'.mat')); %Q
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridA10SharpMQ_',num2str(z),'.mat')); %Q
    %gridMMQ=zeros(size(gridAMQ)); %MQ doesn't form below atomic cooling mass according to Tal Alexander's work
    end  
      end
end
...
if(z>65)%||z==15)
    gridA=0;gridM=0;
    gridAMQ=0;gridMMQ=0;
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridM_',num2str(z),'_1.mat'));
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridA_',num2str(z),'_1.mat'));
    if Ispec>2
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridMMQ_',num2str(z),'_1.mat')); %Q
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridAMQ_',num2str(z),'_1.mat'));   %Q
    %gridMMQ=zeros(size(gridAMQ)); %MQ doesn't form below atomic cooling mass according to Tal Alexander's work
    end
else
    if FSfunc==1
    gridA=0;gridM=0;
    gridAMQ=0;gridMMQ=0;
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridM10_',num2str(z),'_1.mat'));
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridA10_',num2str(z),'_1.mat'));
    if Ispec>2
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridMMQ10_',num2str(z),'_1.mat')); %Q
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridAMQ10_',num2str(z),'_1.mat'));   %Q
    %gridMMQ=zeros(size(gridAMQ)); %MQ doesn't form below atomic cooling mass according to Tal Alexander's work
    end
    end
    if FSfunc==2
    gridA=0;gridM=0;
    gridAMQ=0;gridMMQ=0;
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridM10Sharp_',num2str(z),'_1.mat'));
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridA10Sharp_',num2str(z),'_1.mat'));
    if Ispec>2
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridM10SharpMQ_',num2str(z),'_1.mat')); %Q
    load(strcat('/scratch300/matanlotem/DataBackgrounds_withPlanck/gridA10SharpMQ_',num2str(z),'_1.mat')); %Q
    %gridMMQ=zeros(size(gridAMQ)); %MQ doesn't form below atomic cooling mass according to Tal Alexander's work
    end
    end
end
